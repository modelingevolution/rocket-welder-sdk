...
class UiEventsProjection:
    ...
    def __init__(
        ...
        eventstore_client: EventStoreDBClient,  # type: ignore[name-defined]
    ) -> None:
        """
        ...
        self._eventstore_client: EventStoreDBClient = eventstore_client  # type: ignore[name-defined]
    ...
    async def _handle_event(self, recorded_event: RecordedEvent) -> None:  # type: ignore[name-defined]
        """
        ...
        try:
            ...
            event_data: dict[str, Any] = recorded_event.data
