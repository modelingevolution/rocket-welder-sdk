...
/// inspects it and flags the pass done only when <see cref="Completed"/> is true. A move failure
/// (joint limit, collision) or cancellation stops the traversal at the point it reached and
/// surfaces it in <see cref="StoppedAt"/>; that is the only intrinsic stop.
/// </summary>
